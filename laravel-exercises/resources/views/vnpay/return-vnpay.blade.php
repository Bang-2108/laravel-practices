...
<body>
    ...
    if ($vnp_SecureHash === null) {
        echo "Lỗi: Không tìm thấy vnp_SecureHash trong yêu cầu.";
        exit;
    }
    ...
    <div class="container">
        ...
        <div class="table-responsive">
            ...
            <div class="form-group">
                ...
                <label>
                    ...
                    if ($secureHash == $vnp_SecureHash) {
                        if ($_GET['vnp_ResponseCode'] == '00') {
                            ...
                            $date_time = substr($time, 0, 4) . '-' . substr($time, 4, 2) . '-' . substr($time, 6, 2) . ' ' .
                ...
                <br>
                <a href="/homepage" class="btn btn-lg btn-info">Quay lại</a>
            </div>
        </div>
